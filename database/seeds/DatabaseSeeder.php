...
class RasgoItemTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$rango1 = Rasgo::create([
			'name' => 'SOCIAL',
			'desc' => 'En este campo la motivación es estar en contacto con las personas atendiendo sus dimensiones psico-sociales es decir atendiendo su mundo emocional, social, familiar e incluso espiritual  como ser en actividades de: servicio a la comunidad, docencia, asistente social, derecho, periodismo, política, filosofía, antropología  y afines.',
		...
		$rango3 = Rasgo::create([
			'name' => 'TECNOLOGÍA',
			'desc' => 'En este campo la motivación es el desarrollo y el uso de la tecnología en todas sus formas para construir, armar, comunicar y similares, en actividades técnicas, electrónica, informática, etc.',
		...
		$rango4 = Rasgo::create([
			'name' => 'ARTE',
			'desc' => 'En este campo la motivación es poder expresar pensamientos y sentimientos a través de una forma elegida dentro del arte en general, con creatividad, para producir belleza y armonía realizando actividades como ser: baile, música, pintura, escultura, ejecución de instrumentos y afines.',
		...
		$rango5 = Rasgo::create([
			...
			'desc' => 'En este campo la motivación es involucrarse con el mundo económico, el comercio, la administración y otros en actividades lucrativas, de liderazgo, de management y similares.',
